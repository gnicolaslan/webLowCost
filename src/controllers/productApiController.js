...
const { getOneProduct, getProductByKeyword, getProductsByCategory, getProductsByBrand, getProductsByOffer, getAllBrands, getAllCategories } = require('../services/productServices');
        ...
        try {
            ...
            if (result.length === 0) {
                return res.status(404).json({
                    ok: false,
                    message: 'No se encontraron productos que coincidan con la palabra clave proporcionada.',
                    keyword: keyword
                });
            }
